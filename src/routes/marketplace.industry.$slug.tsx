...
export const Route = createFileRoute("/marketplace/industry/$slug")({
  component: IndustryPage,
});

function IndustryPage() {
  const { slug } = useParams({ from: "/marketplace/industry/$slug" });
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className={`pt-16 transition-all duration-300 ${sidebarOpen ? "lg:pl-56" : "lg:pl-16"}`}>
        <div className="px-6 py-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">{list.length} products in this industry</p>
